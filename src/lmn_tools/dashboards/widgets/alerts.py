...
def create_resource_alerts_widget(
    client: LMClient, dashboard_id: int, devices: list[str], position: WidgetPosition
) -> int | None:
    """
    ...
    widget_data = {
        ...
        "rowSpan": 3,
        "displaySettings": {"showTypeIcon": True, "displayAs": "grid"},
    ...
    widget_data = {
        ...
        "displaySettings": {
            "columns": [
                {
                    "visible": True,
                    "columnLabel": "Interface",
                    "columnSize": 280,
                    "columnKey": "device-name-1452842526600",
                },
                {
                    "visible": True,
                    "columnLabel": "In Discards",
                    "columnSize": 100,
                    "columnKey": "0",
                },
                {
                    "visible": True,
                    "columnLabel": "Out Discards",
                    "columnSize": 100,
                    "columnKey": "1",
                },
                ...
                {
                    "visible": True,
                    "columnLabel": "In Discard %",
                    "columnSize": 100,
                    "columnKey": "4",
                },
                {
                    "visible": True,
                    "columnLabel": "Out Discard %",
                    "columnSize": 100,
                    "columnKey": "5",
                },
            ],
